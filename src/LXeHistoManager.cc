...
void LXeHistoManager::Book()
{
  ...
  analysisManager->CreateH1(
    "E dep", "energy deposition in scintillator per event", nbins, 1e-7, 2e-6);

  // 8 
  analysisManager->CreateH1("energy created", "energy of photons generated", nbins,
			    1e-6, 3e-6);
  ...
  analysisManager->CreateNtupleDColumn("hitPMT");
  analysisManager->CreateNtupleDColumn("hitScint");
  analysisManager->CreateNtupleDColumn("xint");
  analysisManager->CreateNtupleDColumn("yint");
  analysisManager->CreateNtupleDColumn("zint");
  analysisManager->FinishNtuple(0);

  analysisManager->CreateNtuple("PMT", "Energy");
  analysisManager->CreateNtupleDColumn("EPMT");
